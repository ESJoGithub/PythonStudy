...
class menubar(Methods):
  ...
  def run_submenu(self):
    ...
    btn_img1 = Image.open("./img/01_open.png")
    btn_img2 = Image.open("./img/02_save.png")
    btn_img3 = Image.open("./img/03_select.png")
    btn_img4 = Image.open("./img/04_crop.png")
    btn_img5 = Image.open("./img/05_line.png")
