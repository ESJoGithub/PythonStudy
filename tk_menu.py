...
class menubar(Methods):
  ...
  def run_menu(self):
    ...
    menu_2.add_command(label="실행 취소")
    menu_2.add_command(label="다시 실행")
    ...
    menu_3.add_separator()
    menu_3.add_command(label="이미지 180도 회전")
    menu_3.add_command(label="이미지 90도 시계 방향 회전")
    menu_3.add_command(label="이미지 90도 시계 반대 방향 회전")
    ...
    menu_5.add_command(label="흐리게")
    menu_5.add_command(label="선명하게")
